...
> the twelve defects in 14.1 and eight of the sixteen in 14.2 are fixed across all three repos —
...
| P2  | medium   | **`command_contract.json` has no sha256 pin**, unlike the other two contracts. An edit in place would pass the local parity suite trivially while diverging from mc-chat — defeating the entire purpose of the parity mechanism for that file.                                                                                                                                                                                                                                           | `MCProxy/src/mcapp/contract_parity_tests.py:27`                                           | open                                                                                      |
...
| P7  | medium   | **`NodeGroupsCard.vue` has no component test at all**, while all three sibling node-settings cards do. Its `0..99999` validation, revert-on-invalid and per-index ack wiring are entirely uncovered.                                                                                                                                                                                                                                                                                     | `webapp/src/components/bluetooth/node-settings/`                                          | open                                                                                      |
